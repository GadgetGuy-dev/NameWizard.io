...
- Mistral, Perplexity, and local Ollama support
- Services include graceful fallbacks when API keys are unavailable

## External Dependencies

### AI/ML Services
- **OpenAI API**: Primary AI provider for text analysis and vision (OCR)
- **Anthropic API**: Claude models for name suggestions and content analysis
- **Google APIs**: Gemini for AI processing, Google Drive integration
