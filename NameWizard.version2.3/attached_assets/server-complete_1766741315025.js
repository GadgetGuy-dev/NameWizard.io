...
const PLAN_CONFIG = {
  starter: {
    name: 'Starter', filesPerMonth: 15, magicFolders: 5, speed: 'standard', speedMs: [1500, 2500],
    features: { 
      ...
      customInstructions: false, undoHistory: 'last', deduplication: 'hash', priorityProcessing: false,
    ...
    textModels: ['llama-3.2-3b-instruct'], 
    imageModels: ['llama-3.2-11b-vision-instruct'],
    ocrProviders: ['tesseract'], 
    audioProviders: []
  },
  free: {
    name: 'Free', filesPerMonth: 10, magicFolders: 5, speed: 'standard', speedMs: [1500, 2500],
    features: { 
      ocr: 'basic', vision: true, magicFolders: 5, cloudSync: false, handwriting: false, 
      watchAgents: false, audioTranscription: false, teamWorkspaces: false, apiAccess: false, 
      customInstructions: false, undoHistory: 'last', deduplication: 'hash', priorityProcessing: false,
  ...
  pro: {
    name: 'Pro', filesPerMonth: 200, magicFolders: -1, speed: 'standard', speedMs: [1500, 2500],
    features: { 
      ocr: 'basic', vision: true, magicFolders: -1, cloudSync: false, handwriting: false, 
      watchAgents: false, audioTranscription: false, teamWorkspaces: false, apiAccess: false, 
      customInstructions: false, undoHistory: 'last', deduplication: 'hash', priorityProcessing: false,
      tableRecognition: false, documentUnderstanding: false, formulaRecognition: false,
      desktopApp: true, batchRename: true, autoRename: true, normalSupport: true
  ...
  poweruser: {
    name: 'Power User', filesPerMonth: 1000, magicFolders: -1, speed: 'fast', speedMs: [500, 1000],
    features: { 
    ...
    textModels: ['llama-3.3-70b-instruct', 'llama-3.1-8b-instruct', 'gpt-3.5-turbo', 'claude-3-haiku'],
    imageModels: ['qwen3-vl', 'llama-4-scout', 'llava-13b', 'gemini-pro-vision'],
    ocrProviders: ['paddleocr', 'tesseract'], 
    audioProviders: []
  },
  ultimate: {
    name: 'Ultimate', filesPerMonth: 5000, magicFolders: -1, speed: 'instant', speedMs: [200, 400],
    features: { 
      ocr: 'full', vision: true, magicFolders: -1, cloudSync: true, handwriting: true, 
    ...
    textModels: ['llama-3.3-70b-instruct', 'claude-3-sonnet', 'gpt-4-turbo', 'claude-3-opus', 'gpt-3.5-turbo'],
    imageModels: ['qwen3-vl', 'gpt-4-vision', 'claude-3-vision', 'llama-4-scout', 'gemini-pro-vision'],
    ocrProviders: ['paddleocr', 'google-cloud-vision', 'aws-textract', 'azure-document-intelligence', 'tesseract'],
    audioProviders: ['whisper', 'google-speech', 'aws-transcribe']
  },
  paygo: {
    name: 'Pay-as-you-go', filesPerMonth: -1, magicFolders: -1, speed: 'fast', speedMs: [500, 1000],
    creditBased: true, creditCost: 1, // 1 credit per file
    features: { 
      ocr: 'full', vision: true, magicFolders: -1, cloudSync: true, handwriting: true, 
      watchAgents: false, audioTranscription: true, teamWorkspaces: false, apiAccess: false, 
      customInstructions: true, undoHistory: 'full', deduplication: 'semantic', priorityProcessing: true,
      tableRecognition: true, documentUnderstanding: true, formulaRecognition: true
    },
    textModels: ['llama-3.3-70b-instruct', 'llama-3.1-8b-instruct', 'gpt-3.5-turbo', 'claude-3-haiku'],
  ...
  business: {
    name: 'Business', filesPerMonth: 5000, magicFolders: -1, speed: 'instant', speedMs: [200, 400],
    features: { 
      ocr: 'full', vision: true, magicFolders: -1, cloudSync: true, handwriting: true, 
      watchAgents: true, audioTranscription: true, teamWorkspaces: true, apiAccess: true, 
      customInstructions: true, undoHistory: 'full', deduplication: 'semantic', priorityProcessing: true,
  ...
  god: {
    name: 'God', filesPerMonth: 999999, magicFolders: -1, speed: 'instant', speedMs: [100, 200],
    features: { 
      ocr: 'full', vision: true, magicFolders: -1, cloudSync: true, handwriting: true, 
      watchAgents: true, audioTranscription: true, teamWorkspaces: true, apiAccess: true, 
      customInstructions: true, undoHistory: 'full', deduplication: 'semantic', priorityProcessing: true,
    ...
    textModels: 'all', imageModels: 'all', ocrProviders: 'all', audioProviders: 'all'
  }
};
// Credit pricing tiers
const CREDIT_PRICING = {
  100: 5,    // $5 for 100 credits
  200: 10,   // $10 for 200 credits
  300: 15,   // $15 for 300 credits
  400: 20,   // $20 for 400 credits
  500: 25,   // $25 for 500 credits
  600: 30,   // $30 for 600 credits
  700: 35,   // $35 for 700 credits
  800: 40,   // $40 for 800 credits
  900: 45,   // $45 for 900 credits
  1000: 50   // $50 for 1000 credits (max)
};

// API Provider routing by tier - Primary → Secondary → Tertiary → Fallback
const API_ROUTING = {
  text: {
    free: { primary: 'llama-3.2-3b-instruct', backup1: null, backup2: null, fallback: 'local' },
    paygo: { primary: 'llama-3.3-70b-instruct', backup1: 'llama-3.1-8b-instruct', backup2: 'gpt-3.5-turbo', fallback: 'local' },
    pro: { primary: 'llama-3.3-70b-instruct', backup1: 'llama-3.1-8b-instruct', backup2: 'gpt-3.5-turbo', fallback: 'local' },
    business: { primary: 'llama-3.3-70b-instruct', backup1: 'claude-3-sonnet', backup2: 'gpt-4-turbo', fallback: 'gpt-3.5-turbo' },
    god: { primary: 'llama-3.3-70b-instruct', backup1: 'claude-3-opus', backup2: 'gpt-4-turbo', fallback: 'gpt-3.5-turbo' }
  },
  vision: {
    free: { primary: 'llama-3.2-11b-vision-instruct', backup1: null, backup2: null, fallback: 'local' },
    paygo: { primary: 'qwen3-vl', backup1: 'llama-4-scout', backup2: 'llava-13b', fallback: 'local' },
    pro: { primary: 'qwen3-vl', backup1: 'llama-4-scout', backup2: 'llava-13b', fallback: 'local' },
    business: { primary: 'qwen3-vl', backup1: 'gpt-4-vision', backup2: 'claude-3-vision', fallback: 'llava-13b' },
    god: { primary: 'qwen3-vl', backup1: 'gpt-4-vision', backup2: 'claude-3-vision', fallback: 'llama-4-scout' }
  },
  ocr: {
    free: { primary: 'tesseract', backup1: null, backup2: null, fallback: 'local' },
    paygo: { primary: 'paddleocr', backup1: 'tesseract', backup2: null, fallback: 'local' },
    pro: { primary: 'paddleocr', backup1: 'tesseract', backup2: null, fallback: 'local' },
    business: { primary: 'paddleocr', backup1: 'google-cloud-vision', backup2: 'aws-textract', fallback: 'tesseract' },
    god: { primary: 'paddleocr', backup1: 'google-cloud-vision', backup2: 'aws-textract', fallback: 'tesseract' }
  },
  audio: {
    free: { primary: null, backup1: null, backup2: null, fallback: null },
    paygo: { primary: 'whisper', backup1: null, backup2: null, fallback: null },
    pro: { primary: null, backup1: null, backup2: null, fallback: null },
    business: { primary: 'whisper', backup1: 'google-speech', backup2: 'aws-transcribe', fallback: null },
    god: { primary: 'whisper', backup1: 'google-speech', backup2: 'aws-transcribe', fallback: null }
  }
};
...
const OPENROUTER_MODELS = {
  ...
  'qwen3-vl': 'qwen/qwen-2.5-vl-72b-instruct',
  'llava-13b': 'liuhaotian/llava-v1.6-34b',
  'gemini-pro-vision': 'google/gemini-pro-vision',
  'mistral-large': 'mistralai/mistral-large-2411'
};

// All available API providers with their configuration
const API_PROVIDERS = {
  // OCR Providers
  tesseract: { name: 'Tesseract', type: 'ocr', selfHosted: true, free: true, envKey: null },
  paddleocr: { name: 'PaddleOCR', type: 'ocr', selfHosted: true, free: true, envKey: 'PADDLEOCR_API_URL' },
  'google-cloud-vision': { name: 'Google Cloud Vision', type: 'ocr', selfHosted: false, free: false, envKey: 'GOOGLE_CLOUD_API_KEY' },
  'aws-textract': { name: 'AWS Textract', type: 'ocr', selfHosted: false, free: false, envKey: 'AWS_ACCESS_KEY_ID' },
  'azure-document-intelligence': { name: 'Azure Document Intelligence', type: 'ocr', selfHosted: false, free: false, envKey: 'AZURE_DOC_ENDPOINT' },
  datalab: { name: 'Datalab', type: 'ocr', selfHosted: false, free: false, envKey: 'DATALAB_API_KEY' },
  docling: { name: 'Docling', type: 'ocr', selfHosted: true, free: true, envKey: 'DOCLING_API_URL' },
  
  // LLM Providers (via OpenRouter or direct)
  openrouter: { name: 'OpenRouter', type: 'llm', selfHosted: false, free: true, envKey: 'OPENROUTER_API_KEY' },
  openai: { name: 'OpenAI', type: 'llm', selfHosted: false, free: false, envKey: 'OPENAI_API_KEY' },
  anthropic: { name: 'Anthropic', type: 'llm', selfHosted: false, free: false, envKey: 'ANTHROPIC_API_KEY' },
  google: { name: 'Google AI (Gemini)', type: 'llm', selfHosted: false, free: false, envKey: 'GOOGLE_AI_API_KEY' },
  together: { name: 'Together.ai', type: 'llm', selfHosted: false, free: false, envKey: 'TOGETHER_API_KEY' },
  replicate: { name: 'Replicate', type: 'llm', selfHosted: false, free: false, envKey: 'REPLICATE_API_TOKEN' },
  
  // Audio Providers
  whisper: { name: 'OpenAI Whisper', type: 'audio', selfHosted: false, free: false, envKey: 'OPENAI_API_KEY' },
  'google-speech': { name: 'Google Speech-to-Text', type: 'audio', selfHosted: false, free: false, envKey: 'GOOGLE_CLOUD_API_KEY' },
  'aws-transcribe': { name: 'AWS Transcribe', type: 'audio', selfHosted: false, free: false, envKey: 'AWS_ACCESS_KEY_ID' }
};
