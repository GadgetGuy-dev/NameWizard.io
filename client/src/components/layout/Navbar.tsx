        ...
        <div className="flex items-center gap-4">
          {user ? (
            ...
            <div className="flex items-center gap-3">
              <Link href="/auth">
                <Button variant="outline" className="border-zinc-700 text-gray-300 hover:text-white hover:bg-zinc-800" data-testid="button-login-nav">
                  Login
                </Button>
              </Link>
              <Link href="/auth">
                <Button className="bg-orange-500 hover:bg-orange-600 text-white" data-testid="button-signup-nav">
                  Sign up
                </Button>
              </Link>
            </div>
